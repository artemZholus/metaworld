...
class SawyerDrawerCloseRotatedEnvV2(SawyerXYZEnv):
    _TARGET_RADIUS = 0.04
    ...
    def new_drawer_position(self, init_position, angle):
        box_position = init_position.copy()
        self._angle = angle
        ...
        goal_position = M @ self.goal_delta + box_position
        return box_position, box_quat, goal_position
    ...
    def reset_model(self):
        ...
        box_position, box_quat, goal_position = self.new_drawer_position(init_pos, angle)
        ...
        # self.sim.model.site_pos[self.sim.model.site_name2id('goal')] = self._target_pos
