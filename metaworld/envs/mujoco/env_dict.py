...
from metaworld.envs.mujoco.sawyer_xyz.v2 import (
    ...
    SawyerDrawerCloseRotatedEnvV2,
    SawyerDrawerOpenRotatedEnvV2,
...
ALL_V2_ENVIRONMENTS = OrderedDict((
    ...
    ('drawer-close-rotated-v2', SawyerDrawerCloseRotatedEnvV2),
    ('drawer-open-rotated-v2', SawyerDrawerOpenRotatedEnvV2),
